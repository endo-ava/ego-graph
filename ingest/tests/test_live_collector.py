...
def main():
    ...
    # 環境変数の存在確認
    missing_vars = []
    if not client_id: missing_vars.append("SPOTIFY_CLIENT_ID")
    if not client_secret: missing_vars.append("SPOTIFY_CLIENT_SECRET")
    if not refresh_token: missing_vars.append("SPOTIFY_REFRESH_TOKEN")
